      ...
      <div className="flex flex-col justify-center items-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          ...
          <p className="py-4 text-lg md:text-xl">
            Feel free to get in touch with me by sending me a message below
          </p>
        </div>

        <div className="w-full md:w-3/4 lg:w-1/2">
          <form
            action="https://getform.io/f/aqonnpka"
            method="POST"
          ...
          >
            ...
            <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-600 px-6 py-3 my-4 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
              Let's talk
            </button>
          </form>
        </div>
